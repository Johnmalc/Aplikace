...
//	    HttpPost httppost = new HttpPost("http://www.xxx.cz/vyhledavani?text=");
//	   
...
public class Connection {		
	    ...
	    private static final String URLObj = null;
		...
		public static void main(String[] args) {
	        try {
	            ...
	            URL = new URL("http://www.xxx.cz/vyhledavani?text=" + a);
	        ...
	        try {
	          ...
	          /* int a = new Scanner(System.in).nextInt();
	    	            ...
	    	            if(URLObj != "http://www.xxx.cz/vyrobek-nenalezen") { 
	    	            	System.out.println("kjsngv");}
	    	            else ("Ssjkndkcn");
...
//	    	              System.out.println(lineRead);
		 ...
		 * @param b
		 */
		private static void setDoOutput(boolean b) {
		 ...
		 * @param b
		 */
		private static void setDoInput(boolean b) {
			// TODO Auto-generated method stub
...
//	    try {
//	        URL url = new URL("http://www.xxx.cz");
//	        connection = (HttpURLConnection) url.openConnection();
//	        connection.connect();
//	        connection.getInputStream();  		        
//	        System.out.println("Connected to xxx.cz");   
////	       
//	        System.out.println("Zadejte vase cisla pro vyhledavani");	
...
//			builder.setScheme("http").setHost("www.xxx.cz").setPath("/vyhledavani")
//		      	   .setParameter("text", "");
//		URI uri = builder.build();
//		HttpGet httpget = new HttpGet(uri);
//		
//		// http://www.xxx.cz/vyhledavani?text=dsfsmf%2C
